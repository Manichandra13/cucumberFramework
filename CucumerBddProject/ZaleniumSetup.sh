...
echo ""
    ...
    docker run --rm -ti --name zalenium -p 4444:4444 \
      ...
      --privileged dosel/zalenium start --desiredContainers $givenContainers --maxDockerSeleniumContainers $maxDockerContainers --maxTestSessions 150 --videoRecordingEnabled $videoRecording --timeZone $zone
