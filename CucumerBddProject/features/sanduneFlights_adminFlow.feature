...
Feature: Flights Admin Flow for sandune
  ...
  #33 Testcases
  #This test case verifies changing international flights as an admin user in sandune flow
  @SmokeTest
  Scenario Outline: Admin Flow Change Flights Validation under sandune flow
  ...
  @SmokeTest
  Scenario Outline: Admin Flow Change Flights With Smart Filter Validation under sandune flow
    Given Login as a authenticated admin user
    And User selects the region "<region>" from destination options
    And User selects the departing city "<dep_city>" from the dropdown
    And User chooses the month "<dubai_month>" for the trip
  ...
  #This test case verifies choosing a Direct international flight using the filter option as an admin user in sandune flow
  Scenario Outline: Admin Flow Choose Direct Flights Validation under sandune flow
    Given Login as a authenticated admin user
    And User selects the region "<region>" from destination options
    And User selects the departing city "<dep_city>" from the dropdown
    And User chooses the month "<dubai_month>" for the trip
  ...
  #This test case verifies choosing a 2-stop flight using the filter option as an admin user in sandune flow
  Scenario Outline: Admin Flow Choose Two-Stop Flights Validation under sandune flow
    Given Login as a authenticated admin user
    And User selects the region "<region>" from destination options
    And User selects the departing city "<dep_city>" from the dropdown
    And User chooses the month "<dubai_month>" for the trip
  ...
  #This test case verifies choosing an early morning flight for onward journey as an admin user in sandune flow
  Scenario Outline: Admin Flow Choose Onward Early Morning Flights Validation under sandune flow
    Given Login as a authenticated admin user
    And User selects the region "<region>" from destination options
    And User selects the departing city "<dep_city>" from the dropdown
    And User chooses the month "<dubai_month>" for the trip
  ...
  #This test case verifies choosing an early morning flight for return journey as an admin user in sandune flow
  Scenario Outline: Admin Flow Choose Return Early Morning Flights Validation under sandune flow
    Given Login as a authenticated admin user
    And User selects the region "<region>" from destination options
    And User selects the departing city "<dep_city>" from the dropdown
    And User chooses the month "<dubai_month>" for the trip
  ...
  #This test case verifies choosing a morning flight for onward journey as an admin user in sandune flow
  Scenario Outline: Admin Flow Choose Onward Morning Flights Validation under sandune flow
    Given Login as a authenticated admin user
    And User selects the region "<region>" from destination options
    And User selects the departing city "<dep_city>" from the dropdown
    And User chooses the month "<dubai_month>" for the trip
  ...
  #This test case verifies choosing a morning flight for return journey as an admin user in sandune flow
  Scenario Outline: Admin Flow Choose Return Morning Flights Validation under sandune flow
    Given Login as a authenticated admin user
    And User selects the region "<region>" from destination options
    And User selects the departing city "<dep_city>" from the dropdown
    And User chooses the month "<dubai_month>" for the trip
  ...
  #This test case verifies choosing a mid-day flight for onward journey as an admin user in sandune flow
  Scenario Outline: Admin Flow Choose Onward Mid-day Flights Validation under sandune flow
    Given Login as a authenticated admin user
    And User selects the region "<region>" from destination options
    And User selects the departing city "<dep_city>" from the dropdown
    And User chooses the month "<dubai_month>" for the trip
  ...
  #This test case verifies choosing a mid-day flight for return journey as an admin user in sandune flow
  Scenario Outline: Admin Flow Choose Return Mid-day Flights Validation under sandune flow
    Given Login as a authenticated admin user
    And User selects the region "<region>" from destination options
    And User selects the departing city "<dep_city>" from the dropdown
    And User chooses the month "<dubai_month>" for the trip
  ...
  #This test case verifies choosing a night flight for onward journey as an admin user in sandune flow
  Scenario Outline: Admin Flow Choose Onward Night Flights Validation under sandune flow
    Given Login as a authenticated admin user
    And User selects the region "<region>" from destination options
    And User selects the departing city "<dep_city>" from the dropdown
    And User chooses the month "<dubai_month>" for the trip
  ...
  #This test case verifies choosing a night flight for return journey as an admin user in sandune flow
  Scenario Outline: Admin Flow Choose Return Night Flights Validation under sandune flow
    Given Login as a authenticated admin user
    And User selects the region "<region>" from destination options
    And User selects the departing city "<dep_city>" from the dropdown
    And User chooses the month "<dubai_month>" for the trip
  ...
  #This test case verifies choosing a refundable international flight as an admin user in sandune flow
  Scenario Outline: Admin Flow Choose Refundable Flights Validation under sandune flow
    Given Login as a authenticated admin user
    And User selects the region "<region>" from destination options
    And User selects the departing city "<dep_city>" from the dropdown
    And User chooses the month "<dubai_month>" for the trip
  ...
  #This test case verifies choosing a non-refundable international flight as an admin user in sandune flow
  Scenario Outline: Admin Flow Choose Non Refundable Flights Validation under sandune flow
    Given Login as a authenticated admin user
    And User selects the region "<region>" from destination options
    And User selects the departing city "<dep_city>" from the dropdown
    And User chooses the month "<dubai_month>" for the trip
