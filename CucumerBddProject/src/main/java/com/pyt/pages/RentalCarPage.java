...
public class RentalCarPage {
	...
	@FindBy(xpath = "//a[contains(text(),'Large 4x4')]")
	WebElement largeFilterRentalCar;

	@FindBy(xpath = "//a[contains(text(),'Premium 4x4')]")
	WebElement premiumFilterRentalCar;

	@FindBy(xpath = "//a[contains(text(),'11 seater van')]")
	...
	// change button
	@FindBy(xpath = "//div[contains(@name,'all-transfer-panels')]//button")
